...
export class BudgetController {
  ...
  async create(@Body() body: BudgetDto): Promise<any> {
  ...
  async findFiltered(
    ...
    return this.budgetService.findFiltered(body, property);
  }
  ...
  async delete(@Param('budget_number') budget_number: string): Promise<void> {
